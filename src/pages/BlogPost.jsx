...
export default function BlogPost() {
  ...
  return (
    ...
    >
          ...
          <div className="absolute top-4 left-4 sm:top-8 sm:left-8 z-10">
            ...
            >
              <div className="bg-[#3b60ff] p-1 rounded sm:p-1.5 sm:rounded-lg text-white shadow-lg">
                <MapPin size={12} sm:size={16} strokeWidth={3} />
              </div>
              <span className="font-black italic uppercase text-[9px] sm:text-sm tracking-widest dark:text-white">
                {post.location}
              </span>
            </motion.div>
          </div>
      ...
      <BlogPostCTA onNavigate={() => navigate("/ai-planner", { state: { destination: post.location || post.title } })} lang={lang} />
    </motion.div>
  );
}
