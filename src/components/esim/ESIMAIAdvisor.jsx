  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center gap-6 shadow-xl border border-zinc-100 dark:border-zinc-800">
      ...
      <div className="flex-1 text-center md:text-left space-y-1">
        <h3 className="text-[7px] sm:text-[8px] sm:text-[9px] sm:text-[10px] sm:text-xs sm:text-sm sm:text-base sm:text-lg sm:text-xl sm:text-2xl font-bold text-zinc-900 dark:text-white">
          {t("esimShop.aiAdvisor.title")}
        </h3>
        <p className="text-zinc-500 dark:text-zinc-400">{t("esimShop.aiAdvisor.subtitle")}</p>
        <p className="text-blue-600 dark:text-blue-400 text-[7px] sm:text-[8px] sm:text-[9px] sm:text-[10px] sm:text-xs sm:text-sm font-medium pt-1">
          {currentTip}
        </p>
      </div>
      <Button
