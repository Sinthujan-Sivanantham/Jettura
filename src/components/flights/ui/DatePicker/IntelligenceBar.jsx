    ...
    return (
        <div className="p-3 lg:p-5 bg-zinc-50 dark:bg-zinc-950 border-t dark:border-zinc-900 flex justify-between items-center px-4 lg:px-10">
            <div className="flex items-center gap-1.5 italic">
                ...
                <span className="text-[10px] lg:text-xs font-black uppercase tracking-widest italic opacity-80" style={{ color: brandColor }}>
                    {isSyncing ? t("search.flight.syncing") : t("search.flight.active")}
                </span>
            </div>
            <button
                onClick={onConfirm}
                className="text-white font-black italic uppercase text-[10px] sm:text-xs lg:text-sm rounded-lg lg:rounded-xl px-6 lg:px-12 py-2 lg:py-3.5 shadow-lg active:scale-95 transition-all"
