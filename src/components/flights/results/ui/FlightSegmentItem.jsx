                ...
                <div className="flex-1 text-left">
                    ...
                    <div className="mb-5">
                        <div className="flex items-center gap-2 mb-2">
                            <p className="text-[7px] sm:text-[8px] md:text-[10px] lg:text-xs xl:text-sm font-black text-zinc-400 uppercase italic tracking-widest">{t("search.flight.details.departure") || "Departure"}</p>
                            <WeatherBadge cityCode={segment.departure.iataCode} />
                        </div>

                        <div className="flex flex-col mb-1">
                            <span className="text-[7px] sm:text-[8px] sm:text-[9px] sm:text-[10px] md:text-xs lg:text-sm xl:text-base font-black text-zinc-400 flex items-center gap-1 mb-0.5">
                                <Calendar size={12} /> {depDate}
                            </span>
                            <p className="text-[7px] sm:text-[8px] sm:text-[9px] sm:text-[10px] sm:text-xs sm:text-sm sm:text-base sm:text-lg md:text-xl lg:text-3xl xl:text-4xl font-black italic uppercase leading-none tracking-tight">
                                {depTime} {t("search.flight.details.timeSuffix") || "Uhr"}
                            </p>
                        </div>
                        <p className="text-[7px] sm:text-[8px] sm:text-[9px] sm:text-[10px] md:text-xs lg:text-base xl:text-lg font-bold uppercase tracking-tight" style={{ color: brandColor }}>
                    ...
                    <div className="flex gap-2 mb-5">
                        <div className="flex items-center gap-1.5 px-2.5 py-1 bg-zinc-50 dark:bg-zinc-900 border dark:border-zinc-800 rounded-lg">
                            ...
                            <span className="text-[7px] sm:text-[8px] sm:text-[9px] md:text-xs lg:text-sm xl:text-base font-black italic text-zinc-500 uppercase">{t(`search.flight.details.cabins.${cabinClass}`) || cabinClass}</span>
                        </div>
                        <div className="flex items-center gap-1.5 px-2.5 py-1 bg-zinc-50 dark:bg-zinc-900 border dark:border-zinc-800 rounded-lg">
                            <Clock size={12} style={{ color: brandColor }} />
                            <span className="text-[7px] sm:text-[8px] sm:text-[9px] md:text-xs lg:text-sm xl:text-base font-black italic text-zinc-500 uppercase">{segment.duration.replace('PT', '').toLowerCase()}</span>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            <p className="text-[7px] sm:text-[8px] md:text-[10px] lg:text-xs xl:text-sm font-black text-zinc-400 uppercase italic tracking-widest">{t("search.flight.details.arrival") || "Arrival"}</p>
                        ...
                        <div className="flex items-center justify-between mt-1">
                            <p className="text-[7px] sm:text-[8px] sm:text-[9px] sm:text-[10px] md:text-xs lg:text-base xl:text-lg font-bold uppercase" style={{ color: brandColor }}>
                                {arrLoc}
                            </p>
                            <div className="flex items-center gap-1.5 bg-amber-50 dark:bg-amber-950/20 px-2 py-0.5 rounded border border-amber-200/50 dark:border-amber-900/30">
                                ...
                                <span className="text-[7px] sm:text-[8px] font-black uppercase text-amber-700 dark:text-amber-500 italic">{t("search.flight.details.visaCheck") || "Visa-Check"}</span>
                            </div>
                        </div>
                    </div>
                </div>
