        ...
        <div className="w-full mb-16 px-4">
            ...
            <div className="flex flex-row justify-between items-center mb-8 sm:mb-10 gap-2">
                ...
                >
                    ...
                    <span className="text-[9px] sm:text-[11px] font-black uppercase tracking-[0.15em] sm:tracking-[0.2em] italic">{t("nav.back") || "Zurück"}</span>
                </motion.button>

                <motion.div
                    initial={{ opacity: 0, x: 10 }}
                    animate={{ opacity: 1, x: 0 }}
                    className="flex items-center gap-1.5 sm:gap-2.5 px-3 sm:px-5 py-2 sm:py-2.5 rounded-full bg-[var(--brand-color)]/10 border border-[var(--brand-color)]/20 text-[8px] sm:text-[11px] font-black uppercase italic tracking-[0.1em] sm:tracking-widest"
                    style={{ color: "var(--brand-color)" }}
                >
                    <ShieldCheck size={12} sm:size={14} fill="currentColor" className="opacity-20" />
                    <Sparkles size={10} sm:size={12} className="animate-pulse" />
            ...
            >
                <div className="inline-flex flex-col items-center">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-black italic uppercase tracking-tighter text-zinc-900 dark:text-white leading-[0.9] mb-4">
