        ...
        <div className="ml-8 mt-6 p-4 bg-zinc-50 dark:bg-zinc-900/50 rounded-[2rem] border dark:border-zinc-800 space-y-4 shadow-inner">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[8px] font-black uppercase italic leading-none mb-1 tracking-widest" style={{ color: brandColor }}>{t("search.flight.details.wait") || "Wait"}</p>
                        <p className="text-xs font-black uppercase italic leading-none tracking-tight">
