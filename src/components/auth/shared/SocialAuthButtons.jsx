    ...
    return (
        <div className="grid grid-cols-2 gap-3 mb-6">
            <Button
                ...
                className="h-12 bg-white dark:bg-zinc-900 border border-slate-300 dark:border-zinc-700 hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-slate-200 font-bold text-base rounded-lg w-full flex items-center justify-center gap-2"
            >
