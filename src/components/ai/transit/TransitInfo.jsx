        ...
        <div className="p-6 lg:p-8 space-y-6 flex flex-col justify-center">
            ...
            <div className="flex gap-4 items-center bg-zinc-50/50 dark:bg-white/5 p-3 rounded-2xl">
                ...
                <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">{t("aiPlanner.results.routeFrom")}</span>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/50 dark:bg-black/20 p-4 rounded-3xl border border-white/20 dark:border-white/5 shadow-sm">
                    <span className="text-[8px] font-black text-zinc-400 dark:text-zinc-500 uppercase block mb-1.5 tracking-wider">{t("aiPlanner.results.duration")}</span>
                    <div className="font-black dark:text-white text-base italic flex items-center gap-2">
                        <Clock size={16} className="text-[var(--brand-color)]" /> {step.duration}
                    </div>
                </div>
                <div className="bg-white/50 dark:bg-black/20 p-4 rounded-3xl border border-white/20 dark:border-white/5 shadow-sm">
                    <span className="text-[8px] font-black text-zinc-400 dark:text-zinc-500 uppercase block mb-1.5 tracking-wider">{t("aiPlanner.results.distance")}</span>
                    <div className="font-black dark:text-white text-base italic flex items-center gap-2">
            ...
            <div className="bg-[var(--brand-color)]/10 dark:bg-[var(--brand-color)]/5 p-4 rounded-2xl border border-[var(--brand-color)]/20 text-[11px] italic text-zinc-700 dark:text-zinc-300 flex gap-3 items-start">
                <Lightbulb className="text-[var(--brand-color)] shrink-0" size={16} />
                <p className="leading-relaxed">"{step.tip}"</p>
            </div>

            <Button
                className="w-full h-14 bg-[var(--brand-color)] hover:brightness-110 text-white font-black rounded-2xl text-xs uppercase shadow-xl shadow-[var(--brand-color)]/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2 tracking-widest"
                onClick={() => {
