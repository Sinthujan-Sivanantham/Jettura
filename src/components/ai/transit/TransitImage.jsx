...
export default function TransitImage({ step, searchId }) {
    ...
    return (
        <div className="h-48 md:h-64 relative bg-zinc-200/50 dark:bg-zinc-800/50">
            ...
            <div className="absolute top-4 left-4 bg-[var(--brand-color)] px-3 py-1 rounded-full text-[10px] font-black text-white uppercase tracking-widest shadow-lg">
                {t("aiPlanner.results.nextStop")}
            </div>
            <div className="absolute bottom-5 left-6 right-6">
                <h3 className="text-white text-2xl font-black uppercase italic tracking-tighter leading-none mb-1 drop-shadow-md">
                    {step.activity}
                </h3>
                <p className="text-white/70 text-[10px] font-medium uppercase tracking-wide flex items-center gap-1.5">
