        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8">
                ...
                <div className="text-center space-y-2">
                    <p className="text-xl font-black italic uppercase tracking-tighter text-zinc-800 dark:text-zinc-200">
            ...
            <div className="w-full mb-8 px-4 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    >
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] italic">{t("nav.back")}</span>
                    </motion.button>
                    <h2 className="text-3xl sm:text-4xl font-black italic uppercase tracking-tighter text-zinc-900 dark:text-white">
                ...
                <div className="flex-1 space-y-4">
                    {filteredOffers.length > 0 ? (
                        ...
                        <div className="min-h-[40vh] flex flex-col items-center justify-center text-center p-8 bg-zinc-50 dark:bg-zinc-900/50 rounded-3xl border-2 border-dashed border-zinc-200 dark:border-zinc-800">
                            ...
                            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">No cars found</h3>
